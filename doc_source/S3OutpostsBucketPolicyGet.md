...
The following topics show you how to view your Amazon S3 on Outposts bucket policy using the AWS Management Console, AWS Command Line Interface \(AWS CLI\), or AWS SDK for Java\. 
