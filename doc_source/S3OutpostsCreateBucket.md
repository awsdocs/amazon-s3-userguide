...
The following examples show you how to create an S3 on Outposts bucket using the AWS Management Console, AWS Command Line Interface \(AWS CLI\), and AWS SDK for Java\.
