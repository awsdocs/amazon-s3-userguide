# Reviewing bucket access using IAM Access Analyzer for S3<a name="access-analyzer"></a>
...
## What information does IAM Access Analyzer for S3 provide?<a name="access-analyzer-information-s3"></a>
