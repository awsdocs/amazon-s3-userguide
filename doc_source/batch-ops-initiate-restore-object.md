...
+ S3 Batch Operations doesn't support restoring a subset of archives in the S3 Intelligent\-Tiering or S3 Glacier Flexible Retrieval storage classes\. To restore a subset of archives in these storage classes, use [RestoreObject](https://docs.aws.amazon.com/AmazonS3/latest/API/API_RestoreObject.html) instead\.  
