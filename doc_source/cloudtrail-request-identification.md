...
In the following Athena query examples, replace *`s3_cloudtrail_events_db.cloudtrail_DOC-EXAMPLE-BUCKET1_table`* with your Athena details, and modify the date range as needed\. 
