...
This section shows several IAM user policies for controlling user access to Amazon S3\. For information about access policy language, see [Bucket policies and user policies](using-iam-policies.md)\.
