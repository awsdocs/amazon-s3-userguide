...
|  s3:ResourceAccount  | Filters access by the AWS Account ID that owns the S3 resource | String | 
|  s3:TlsVersion  | Filters access by TLS Version used by the client | String | 
