...
# Creating a metrics configuration<a name="metrics-configurations"></a>
...
For more information about working with CloudWatch metrics in Amazon S3, see the topics below\.
