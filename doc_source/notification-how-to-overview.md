...
For a list of supported event types, see [Supported event types](notification-how-to-event-types-and-destinations.title.md#supported-notification-event-types)\. 
