...
1. On the **Properties** page, you can configure the following properties for the bucket\.
   ...
   + **Requester Pays** – Enable Requester Pays if you want the requester \(instead of the bucket owner\) to pay for requests and data transfers\. For more information, see [Configuring Requester Pays buckets for storage transfers and usage](RequesterPaysBuckets.md)\. 
